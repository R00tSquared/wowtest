...
#define SAY_ONSLAY1 -1200365
#define SAY_ONSLAY2 -1200366
#define SAY_ONSLAY3 -1200367
...
struct boss_azgalorAI : public hyjal_trashAI
{
    ...
    Timer_UnCheked RainTimer;
    Timer_UnCheked DoomTimer;
    Timer_UnCheked HowlTimer;
    ...
    void KilledUnit(Unit *victim)
    {
        switch(rand()%3)
        {
            case 0:
                ...
                DoYell(-1200365, LANG_UNIVERSAL, NULL);
                break;
            case 1:
                DoPlaySoundToSet(m_creature, SOUND_ONSLAY2);
                DoYell(-1200366, LANG_UNIVERSAL, NULL);
                break;
            case 2:
                DoPlaySoundToSet(m_creature, SOUND_ONSLAY3);
                DoYell(-1200367, LANG_UNIVERSAL, NULL);
                break;
        }
    }
