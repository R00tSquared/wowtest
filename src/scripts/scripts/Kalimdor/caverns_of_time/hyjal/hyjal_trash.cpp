...
struct mob_giant_infernalAI : public hyjal_trashAI
{
    ...
    Timer_UnCheked FlameBuffetTimer;
...
struct mob_necromancerAI : public hyjal_trashAI
{
    ...
    Timer_UnCheked UnholyFrenzyTimer;
...
struct mob_bansheeAI : public hyjal_trashAI
{
    ...
    bool go;
    Timer_UnCheked CourseTimer;
    Timer_UnCheked WailTimer;
    Timer_UnCheked ShellTimer;
    uint32 pos;
...
struct mob_fel_stalkerAI : public hyjal_trashAI
{
    ...
    void UpdateAI(const uint32 diff)
    {
        ...
        {
            if(Unit* target = SelectUnit(SELECT_TARGET_RANDOM, 0, 30, true, POWER_MANA))
...
struct alliance_riflemanAI : public Scripted_NoMovementAI
{
    ...
    Timer_UnCheked ExplodeTimer;
    Timer_UnCheked ShootTimer;
