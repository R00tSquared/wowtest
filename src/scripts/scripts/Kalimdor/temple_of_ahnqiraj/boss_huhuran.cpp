...
struct boss_huhuranAI : public ScriptedAI
{
    ...
    Timer_UnCheked Frenzy_Timer;
    Timer_UnCheked Wyvern_Timer;
    Timer_UnCheked Spit_Timer;
    Timer_UnCheked PoisonBolt_Timer;
    Timer_UnCheked NoxiousPoison_Timer;
    Timer_UnCheked FrenzyBack_Timer;
    ...
    void UpdateAI(const uint32 diff)
    {
        ...
        if ( !Berserk && me->GetHealthPercent() < 31 )
        {
            m_creature->InterruptNonMeleeSpells(false);
