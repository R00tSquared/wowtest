...
struct mob_doom_blossomAI : public NullCreatureAI
{
    ...
    Timer_UnCheked CheckTeronTimer;
...
struct mob_shadowy_constructAI : public ScriptedAI
{
    ...
    Timer_UnCheked DelayTimer;
    Timer_UnCheked CheckTeronTimer;
    Timer_UnCheked ChangeTarget;
...
struct boss_teron_gorefiendAI : public ScriptedAI
{
    ...
    Timer_UnCheked IncinerateTimer;
    Timer_UnCheked SummonDoomBlossomTimer;
    Timer_UnCheked EnrageTimer;
    Timer_UnCheked CrushingShadowsTimer;
    Timer_UnCheked ShadowOfDeathTimer;
    Timer_UnCheked SummonShadowsTimer;
    Timer_UnCheked RandomYellTimer;
    ...
    void MoveInLineOfSight(Unit *who)
    {
        ...
        if (pInstance->GetData(EVENT_SHADEOFAKAMA) != DONE)
            return;
