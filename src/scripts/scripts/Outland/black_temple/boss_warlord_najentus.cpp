...
struct boss_najentusAI : public ScriptedAI
{
    ...
    Timer_UnCheked NeedleSpineTimer;
    Timer_UnCheked EnrageTimer;
    Timer_UnCheked SpecialYellTimer;
    Timer_UnCheked TidalShieldTimer;
    Timer_UnCheked ImpalingSpineTimer;
    ...
    void DestroySpine()
    {
        ...
        for(Map::PlayerList::const_iterator i = PlayerList.begin(); i != PlayerList.end(); ++i)
        {
            ...
            if(plr && plr->HasItemCount(32408,1))
                plr->DestroyItemCount(32408,1, true, false);
        }
    }
