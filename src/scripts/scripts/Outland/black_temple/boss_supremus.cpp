...
struct boss_supremusAI : public ScriptedAI
{
    ...
    Timer_UnCheked MoltenFlameTimer;
    
    Timer_UnCheked SummonFlameTimer;
    Timer_UnCheked SwitchTargetTimer;
    Timer_UnCheked PhaseSwitchTimer;
    Timer_UnCheked MoltenPunch_Timer;
    Timer_UnCheked SummonVolcanoTimer;
    Timer_UnCheked HatefulStrikeTimer;
