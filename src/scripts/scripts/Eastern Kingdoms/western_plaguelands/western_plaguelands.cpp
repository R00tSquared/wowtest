...
#define GOSSIP_HDA1 16232
#define GOSSIP_HDA2 16233
#define GOSSIP_HDA3 16234
#define GOSSIP_HDA4 16235

#define GOSSIP_SDA1 16236
...
bool GossipHello_npcs_dithers_and_arbington(Player *player, Creature *_Creature)
{
    ...
    {
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetHellgroundString(GOSSIP_HDA1), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+1);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetHellgroundString(GOSSIP_HDA2), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+2);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetHellgroundString(GOSSIP_HDA3), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+3);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetHellgroundString(GOSSIP_HDA4), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+4);
...
bool GossipSelect_npcs_dithers_and_arbington(Player *player, Creature *_Creature, uint32 sender, uint32 action)
{
    switch(action)
    {
        ...
        case GOSSIP_ACTION_INFO_DEF+1:
            player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetHellgroundString(GOSSIP_SDA1), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+5);
...
#define GOSSIP_ITEM_ILLUSION    16231
...
bool GossipHello_npc_myranda_the_hag(Player* pPlayer, Creature* pCreature)
{
    ...
    {
        pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, pPlayer->GetSession()->GetHellgroundString(GOSSIP_ITEM_ILLUSION), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
