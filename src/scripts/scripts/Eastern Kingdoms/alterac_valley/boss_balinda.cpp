...
struct boss_balindaAI : public ScriptedAI
{
    ...
    Timer_UnCheked CoCTimer;
    Timer_UnCheked CheckTimer;
    Timer_UnCheked WaterElementalTimer;
    ...
    void JustSummoned(Creature* summ)
    {
        if (summ)
        {
            ...
            summ->SetMaxHealth((6300 + (summ->GetLevel() - 60)*360) * summ->GetCreatureHealthMod());
