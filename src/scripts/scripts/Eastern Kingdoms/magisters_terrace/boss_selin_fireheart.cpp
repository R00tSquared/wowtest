...
struct boss_selin_fireheartAI : public ScriptedAI
{
    ...
    Timer_UnCheked DrainLifeTimer;
    Timer_UnCheked DrainManaTimer;
    Timer_UnCheked FelExplosionTimer;
    Timer_UnCheked DrainCrystalTimer;
    ...
    void JustDied(Unit* killer)
    {
        ...
        if(urand(0, 1) == 0)
            m_creature->SummonCreature(24762, 231.278, -232.552, -6.39954, 1.62473, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 30000);
