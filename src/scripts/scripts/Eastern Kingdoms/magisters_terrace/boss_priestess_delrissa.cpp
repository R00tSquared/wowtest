...
struct boss_priestess_delrissaAI : public ScriptedAI
{
    ...
    Timer_UnCheked Scream_Cooldown;
    Timer_UnCheked Medalion_Cooldown;
    Timer_UnCheked Shield_Timer;
    Timer_UnCheked SWPain_Timer;
    Timer_UnCheked Dispel_Timer;
    Timer_UnCheked Check_Timer;
    Timer_UnCheked ResetThreatTimer;
...
struct boss_kagani_nightstrikeAI : public boss_priestess_guestAI
{
    ...
    Timer_UnCheked Gouge_Timer;
    Timer_UnCheked Kick_Cooldown;
    Timer_UnCheked Vanish_Timer;
    Timer_UnCheked Eviscerate_Timer;
    Timer_UnCheked Backstab_Timer;
    Timer_UnCheked Check_Timer;
...
struct boss_ellris_duskhallowAI : public boss_priestess_guestAI
{
    ...
    Timer_UnCheked Check_Timer;
    Timer_UnCheked Autocast_Timer;
    Timer_UnCheked SummonImp_Timer;
    Timer_UnCheked Seed_of_Corruption_Timer;
    Timer_UnCheked Curse_of_Agony_Timer;
...
struct boss_eramas_brightblazeAI : public boss_priestess_guestAI
{
    ...
    Timer_UnCheked Snap_Kick_Timer;
    Timer_UnCheked ChacraDrain_Timer;
...
struct boss_yazzaiAI : public boss_priestess_guestAI
{
    ...
    Timer_UnCheked FrostNova_Cooldown;
    Timer_UnCheked ConeOfCold_Cooldown;
    Timer_UnCheked Blink_Cooldown;

    Timer_UnCheked Check_Timer;
    Timer_UnCheked Autocast_Timer;
    Timer_UnCheked MeleeCheck_Timer;
    Timer_UnCheked Polymorph_Timer;
    Timer_UnCheked Ice_Block_Timer;
    Timer_UnCheked Blizzard_Timer;
    Timer_UnCheked Ice_Lance_Timer;
...
struct boss_warlord_salarisAI : public boss_priestess_guestAI
{
    ...
    Timer_UnCheked BattleShout_Timer;
    Timer_UnCheked Intercept_Timer;
    Timer_UnCheked Disarm_Timer;
    Timer_UnCheked Piercing_Howl_Timer;
    Timer_UnCheked Frightening_Shout_Timer;
    Timer_UnCheked Hamstring_Timer;
    Timer_UnCheked Mortal_Strike_Timer;
...
struct boss_garaxxasAI : public boss_priestess_guestAI
{
    ...
    Timer_UnCheked GetSliver_Timer;
    Timer_UnCheked Aimed_Shot_Timer;
    Timer_UnCheked Shoot_Timer;
    Timer_UnCheked Concussive_Shot_Timer;
    Timer_UnCheked Multi_Shot_Timer;
    Timer_UnCheked Wing_Clip_Cooldown;
    bool canWingClip;
    Timer_UnCheked Freezing_Trap_Cooldown;
    bool canSetTrap;
    ...
    void UpdateAI(const uint32 diff)
    {
        ...
        if(me->IsWithinDistInMap(me->GetVictim(), 3.0) && canSetTrap)
        {
            ...
            Position pos;
            me->GetValidPointInAngle(pos, 5.5f, me->GetOrientationTo(me->GetVictim()) - me->GetOrientation() + M_PI, true, 5);
            me->GetMotionMaster()->MovePoint(1, pos.x, pos.y, pos.z);
            canSetTrap = false;
        }
...
struct boss_apokoAI : public boss_priestess_guestAI
{
    ...
    Timer_UnCheked Totem_Timer;
    uint8  Totem_Amount;
    Timer_UnCheked War_Stomp_Timer;
    Timer_UnCheked Purge_Timer;
    Timer_UnCheked Healing_Wave_Cooldown;
    Timer_UnCheked Frost_Shock_Timer;
    uint32 TotemSpell;
    bool canHeal;
    SummonList summons;
...
struct boss_zelfanAI : public boss_priestess_guestAI
{
    ...
    Timer_UnCheked Goblin_Dragon_Gun_Timer;
    Timer_UnCheked Rocket_Launch_Timer;
    Timer_UnCheked Recombobulate_Timer;
    Timer_UnCheked High_Explosive_Sheep_Timer;
    Timer_UnCheked Fel_Iron_Bomb_Timer;
...
struct mob_high_explosive_sheepAI : public ScriptedAI
{
    ...
    Timer_UnCheked SelfDestro_Timer;
    Timer_UnCheked Check_Timer;
