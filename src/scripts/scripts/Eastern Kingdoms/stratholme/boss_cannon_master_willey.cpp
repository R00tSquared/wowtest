...
struct boss_cannon_master_willeyAI : public ScriptedAI
{
    ...
    Timer _ChangedNameSummonRifleman_Timer;

    void Reset()
    {
        _ChangedNameShoot_Timer.Reset(1000);
        _ChangedNamePummel_Timer.Reset(7000);
        _ChangedNameKnockAway_Timer.Reset(11000);
        _ChangedNameSummonRifleman_Timer.Reset(15000);
    }
    ...
    void UpdateAI(const uint32 diff)
    {
        ...
        if (_ChangedNamePummel_Timer.Expired(diff))
        {
            ...
            _ChangedNamePummel_Timer = 12000;
        }
        ...
        if (_ChangedNameShoot_Timer.Expired(diff))
        {
            ...
            _ChangedNameShoot_Timer = 1000;
        }

        if (_ChangedNameSummonRifleman_Timer.Expired(diff))
        {
            //Cast
            switch (rand() % 9)
            {
            ...
            _ChangedNameSummonRifleman_Timer = 30000;
        }
