...
struct boss_hex_lord_malacrassAI : public ScriptedAI
{
    ...
    Timer_UnCheked SpiritBolts_Timer;
    Timer_UnCheked DrainPower_Timer;
    Timer_UnCheked SiphonSoul_Timer;
    Timer_UnCheked PlayerAbility_Timer[3];
    Timer_UnCheked CheckAddState_Timer;
    ...
    void UpdateAI(const uint32 diff)
    {
        ...
        if (SpiritBolts_Timer.Expired(diff))
        {
            ...
            else
            {
                ...
                SiphonSoul_Timer.Reset(10000);  // ready to drain
                for(uint8 i = 0; i <3; i++)
                    PlayerAbility_Timer[i].Reset(99999);
            }
        }
...
*/
                ...
                for(uint8 i = 0; i < 3; i++)
                    PlayerAbility_Timer[i].Reset(PlayerAbility[PlayerClass][i].startCooldown);
...
struct boss_thurgAI : public boss_hexlord_addAI
{
    ...
    Timer_UnCheked bloodlust_timer;
...
struct boss_alyson_antilleAI : public boss_hexlord_addAI
{
    ...
    Timer_UnCheked flashheal_timer;
    Timer_UnCheked dispelmagic_timer;
...
struct boss_lord_raadanAI : public boss_hexlord_addAI
{
    ...
    Timer_UnCheked flamebreath_timer;
...
struct boss_darkheartAI : public boss_hexlord_addAI
{
    ...
    Timer_UnCheked psychicwail_timer;
...
struct boss_slitherAI : public boss_hexlord_addAI
{
    ...
    Timer_UnCheked venomspit_timer;
...
struct boss_fenstalkerAI : public boss_hexlord_addAI
{
    ...
    Timer_UnCheked volatileinf_timer;
...
struct boss_koraggAI : public boss_hexlord_addAI
{
    ...
    Timer_UnCheked coldstare_timer;
    Timer_UnCheked mightyblow_timer;
