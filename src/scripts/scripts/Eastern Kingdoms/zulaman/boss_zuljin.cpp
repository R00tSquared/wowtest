...
struct boss_zuljinAI : public ScriptedAI
{
    ...
    Timer_UnCheked Intro_Timer;
    Timer_UnCheked Berserk_Timer;
    
    Timer_UnCheked Whirlwind_Timer;
    Timer_UnCheked Grievous_Throw_Timer;
    
    Timer_UnCheked Creeping_Paralysis_Timer;
    Timer_UnCheked Overpower_Timer;
    
    Timer_UnCheked Claw_Rage_Timer;
    Timer_UnCheked Lynx_Rush_Timer;
    uint32 Claw_Counter;
    Timer_UnCheked Claw_Loop_Timer;
    
    Timer_UnCheked Flame_Whirl_Timer;
    Timer_UnCheked Flame_Breath_Timer;
    Timer_UnCheked Pillar_Of_Fire_Timer;
    ...
    void EnterPhase(uint32 NextPhase)
    {
        ...
        case 4:
            ...
            if(NextPhase == 2)
            {
                ...
                m_creature->CastSpell(m_creature->GetVictim(), SPELL_SUMMON_CYCLONE, true);
            }
            else
