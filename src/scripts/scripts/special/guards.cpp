...
#define GOSSIP_TEXT_TAVERN                    67
#define GOSSIP_TEXT_BANKSCYERS                68
#define GOSSIP_TEXT_BANKALDOR                 69
#define GOSSIP_TEXT_INNSCYERS                 70
#define GOSSIP_TEXT_INNALDOR                  71
#define GOSSIP_TEXT_STABLESCYERS              72
#define GOSSIP_TEXT_STABLEALDOR               73
#define GOSSIP_TEXT_BATTLEMASTERALLIANCE      74
#define GOSSIP_TEXT_BATTLEMASTERHORDE         75
#define GOSSIP_TEXT_BATTLEMASTERARENA         76
#define GOSSIP_TEXT_MANALOOM                  77
#define GOSSIP_TEXT_ALCHEMYLAB                78
#define GOSSIP_TEXT_GEMMERCHANT               79
#define GOSSIP_TEXT_GEMSCYERS                 80
#define GOSSIP_TEXT_GEMALDOR                  81
#define GOSSIP_TEXT_AH_SILVERMOON_1           82
#define GOSSIP_TEXT_AH_SILVERMOON_2           83
#define GOSSIP_TEXT_INN_SILVERMOON_1          84
#define GOSSIP_TEXT_INN_SILVERMOON_2          85
...
{
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BANK), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_HIPPOGRYPH), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_GUILDMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_INN), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_STABLEMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_CLASSTRAINER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_PROFTRAINER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 7);
...
void SendDefaultMenu_guard_azuremyst(Player *player, Creature *_Creature, uint32 action)
{
    ...
    case GOSSIP_ACTION_INFO_DEF + 6:                    //Class trainer
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_DRUID), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 1);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_HUNTER), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 2);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_MAGE), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 3);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_PALADIN), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 4);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_PRIEST), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 5);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_SHAMAN), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 6);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WARRIOR), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 7);
        player->SEND_GOSSIP_MENU(10076, _Creature->GetGUID());
        break;
    case GOSSIP_ACTION_INFO_DEF + 7:                    //Profession trainer
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_ALCHEMY), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 1);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BLACKSMITHING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 2);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_COOKING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 3);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_ENCHANTING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 4);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_ENGINEERING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 5);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_FIRSTAID), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 6);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_FISHING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 7);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_HERBALISM), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 8);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_JEWELCRAFTING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 9);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_LEATHERWORKING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 10);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_MINING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 11);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_SKINNING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 12);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_TAILORING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 13);
...
{
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BANK), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WINDRIDER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_GUILDMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_INN), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_MAILBOX), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_AUCTIONHOUSE), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WEAPONMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 7);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_STABLEMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 8);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BATTLEMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 9);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_CLASSTRAINER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 10);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_PROFTRAINER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 11);

    if (isGameEventActive(8) && (player->HasAura(26681) || player->HasAura(26682)))
        player->ADD_GOSSIP_ITEM(0, "Give me your gift", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 12);
...
void SendDefaultMenu_guard_bluffwatcher(Player *player, Creature *_Creature, uint32 action)
{
    ...
    case GOSSIP_ACTION_INFO_DEF + 6:                    //Auction House
        player->SEND_POI(-1210.00, 94.00, 6, 6, 0, "Auction House");
    ...
    case GOSSIP_ACTION_INFO_DEF + 9:                    //battlemaster
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_ALTERACVALLEY), GOSSIP_SENDER_SEC_BATTLEINFO, GOSSIP_ACTION_INFO_DEF + 1);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_ARATHIBASIN), GOSSIP_SENDER_SEC_BATTLEINFO, GOSSIP_ACTION_INFO_DEF + 2);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WARSONGULCH), GOSSIP_SENDER_SEC_BATTLEINFO, GOSSIP_ACTION_INFO_DEF + 3);
    ...
    case GOSSIP_ACTION_INFO_DEF + 10:                   //Class trainer
        ...
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_HUNTER), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 2);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_MAGE), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 3);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_PRIEST), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 4);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_SHAMAN), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 5);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WARRIOR), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 6);
    ...
    case GOSSIP_ACTION_INFO_DEF + 11:                   //Profession trainer
        ...
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_COOKING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 3);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_ENCHANTING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 4);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_FIRSTAID), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 5);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_FISHING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 6);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_HERBALISM), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 7);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_LEATHERWORKING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 8);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_MINING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 9);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_SKINNING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 10);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_TAILORING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 11);
    ...
    case GOSSIP_ACTION_INFO_DEF + 12:
    {
        ...
        switch (rand() % 4)
        {
        case 0: ItemID = 22144; break;
        case 1: ItemID = 22122; break;
        case 2: ItemID = 22165; break;
        case 3: ItemID = 22158; break;
        }
...
{
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_AUCTIONHOUSE), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BANK), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_HIPPOGRYPH), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_GUILDMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_INN), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_MAILBOX), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_STABLEMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 7);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WEAPONMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 8);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BATTLEMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 9);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_CLASSTRAINER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 10);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_PROFTRAINER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 11);
...
void SendDefaultMenu_guard_darnassus(Player *player, Creature *_Creature, uint32 action)
{
    ...
    case GOSSIP_ACTION_INFO_DEF + 10:                   //Class trainer
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_DRUID), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 1);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_HUNTER), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 2);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_PRIEST), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 3);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_ROGUE), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 4);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WARRIOR), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 5);
        player->SEND_GOSSIP_MENU(4264, _Creature->GetGUID());
        break;
    case GOSSIP_ACTION_INFO_DEF + 11:                   //Profession trainer
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_ALCHEMY), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 1);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_COOKING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 2);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_ENCHANTING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 3);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_FIRSTAID), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 4);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_FISHING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 5);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_HERBALISM), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 6);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_LEATHERWORKING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 7);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_SKINNING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 8);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_TAILORING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 9);
    ...
    case GOSSIP_ACTION_INFO_DEF + 12:
    {
        ...
        switch (rand() % 4)
        {
        case 0: ItemID = 22140; break;
        case 1: ItemID = 22120; break;
        case 2: ItemID = 21979; break;
        case 3: ItemID = 22155; break;
        }
        uint8 msg = player->CanStoreNewItem(NULL_BAG, NULL_SLOT, dest, ItemID, 1);
        if (msg == EQUIP_ERR_OK)
        {
...
void SendDefaultMenu_guard_dunmorogh(Player *player, Creature *_Creature, uint32 action)
{
    ...
    case GOSSIP_ACTION_INFO_DEF + 5:                    //Stable Master
        ...
        break;
    case GOSSIP_ACTION_INFO_DEF + 6:                    //Class trainer
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_HUNTER), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 1);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_MAGE), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 2);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_PALADIN), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 3);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_PRIEST), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 4);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_ROGUE), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 5);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WARLOCK), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 6);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WARRIOR), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 7);
    ...
    case GOSSIP_ACTION_INFO_DEF + 7:                    //Profession trainer
        ...
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_FISHING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 7);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_HERBALISM), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 8);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_LEATHERWORKING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 9);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_MINING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 10);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_SKINNING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 11);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_TAILORING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 12);
...
bool GossipHello_guard_durotar(Player *player, Creature *_Creature)
{
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BANK), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WINDRIDER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_INN), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_STABLEMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_CLASSTRAINER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_PROFTRAINER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
...
{
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BANK), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_GRYPHON), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_GUILDMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_INN), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_STABLEMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_CLASSTRAINER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
...
void SendDefaultMenu_guard_elwynnforest(Player *player, Creature *_Creature, uint32 action)
{
    ...
    case GOSSIP_ACTION_INFO_DEF + 6:                    //Class trainer
        ...
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_PALADIN), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 4);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_PRIEST), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 5);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_ROGUE), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 6);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WARLOCK), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 7);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WARRIOR), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 8);
        player->SEND_GOSSIP_MENU(4264, _Creature->GetGUID());
        break;
    case GOSSIP_ACTION_INFO_DEF + 7:                    //Profession trainer
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_ALCHEMY), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 1);
...
{
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BATHANDLER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_GUILDMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_INN), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_STABLEMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_CLASSTRAINER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_PROFTRAINER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
...
void SendDefaultMenu_guard_eversong(Player *player, Creature *_Creature, uint32 action)
{
    ...
    case GOSSIP_ACTION_INFO_DEF + 6:                    //Profession trainer
        ...
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BLACKSMITHING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 2);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_COOKING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 3);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_ENGINEERING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 4);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_FIRSTAID), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 5);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_FISHING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 6);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_HERBALISM), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 7);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_JEWELCRAFTING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 8);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_LEATHERWORKING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 9);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_MINING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 10);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_SKINNING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 11);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_TAILORING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 12);
...
bool GossipHello_guard_exodar(Player *player, Creature *_Creature)
{
    ...
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BANK), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_GUILDMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_HIPPOGRYPH), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_INN), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_MAILBOX), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_STABLEMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 7);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WEAPONMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 8);
...
void SendDefaultMenu_guard_exodar(Player *player, Creature *_Creature, uint32 action)
{
    ...
    case GOSSIP_ACTION_INFO_DEF + 9:                    //Battlemaster
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_ALTERACVALLEY), GOSSIP_SENDER_SEC_BATTLEINFO, GOSSIP_ACTION_INFO_DEF + 1);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_ARATHIBASIN), GOSSIP_SENDER_SEC_BATTLEINFO, GOSSIP_ACTION_INFO_DEF + 2);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_ARENA), GOSSIP_SENDER_SEC_BATTLEINFO, GOSSIP_ACTION_INFO_DEF + 3);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_EYEOFTHESTORM), GOSSIP_SENDER_SEC_BATTLEINFO, GOSSIP_ACTION_INFO_DEF + 4);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WARSONGULCH), GOSSIP_SENDER_SEC_BATTLEINFO, GOSSIP_ACTION_INFO_DEF + 5);
    ...
    case GOSSIP_ACTION_INFO_DEF + 11:                   //Profession trainer
        ...
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_FISHING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 7);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_JEWELCRAFTING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 8);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_HERBALISM), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 9);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_LEATHERWORKING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 10);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_MINING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 11);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_SKINNING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 12);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_TAILORING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 13);
...
{
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_AUCTIONHOUSE), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_IRONFORGE_BANK), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_DEEPRUNTRAM), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_GRYPHON), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_GUILDMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_INN), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_MAILBOX), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 7);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_STABLEMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 8);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WEAPONMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 9);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BATTLEMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 10);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_CLASSTRAINER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 11);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_PROFTRAINER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 12);

    if (isGameEventActive(8) && (player->HasAura(26681) || player->HasAura(26682)))
        player->ADD_GOSSIP_ITEM(0, "Give me your gift", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 13);
...
void SendDefaultMenu_guard_ironforge(Player *player, Creature *_Creature, uint32 action)
{
    ...
    case GOSSIP_ACTION_INFO_DEF + 11:                   //Class Trainer
        ...
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WARLOCK), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 6);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WARRIOR), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 7);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_SHAMAN), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 8);
    ...
    case GOSSIP_ACTION_INFO_DEF + 13:
    {
        ...
        switch (rand() % 4)
        {
        case 0: ItemID = 22141; break;
        case 1: ItemID = 22119; break;
        case 2: ItemID = 21980; break;
        case 3: ItemID = 22154; break;
        }
        uint8 msg = player->CanStoreNewItem(NULL_BAG, NULL_SLOT, dest, ItemID, 1);
        if (msg == EQUIP_ERR_OK)
        {
...
void SendDefaultMenu_guard_mulgore(Player *player, Creature *_Creature, uint32 action)
{
    ...
    case GOSSIP_ACTION_INFO_DEF + 5:                    //Class trainer
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_DRUID), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 1);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_HUNTER), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 2);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_SHAMAN), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 3);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WARRIOR), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 4);
...
bool GossipHello_guard_orgrimmar(Player *player, Creature *_Creature)
{
    ...
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_MAILBOX), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_AUCTIONHOUSE), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_ZEPPLINMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 7);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WEAPONMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 8);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_STABLEMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 9);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_OFFICERS), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 10);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BATTLEMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 11);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_CLASSTRAINER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 12);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_PROFTRAINER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 13);

    if (isGameEventActive(8) && (player->HasAura(26681) || player->HasAura(26682)))
        player->ADD_GOSSIP_ITEM(0, "Give me your gift", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 14);
...
void SendDefaultMenu_guard_orgrimmar(Player *player, Creature *_Creature, uint32 action)
{
    ...
    case GOSSIP_ACTION_INFO_DEF + 12:                   //class trainer
        ...
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_MAGE), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 2);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_PRIEST), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 3);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_SHAMAN), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 4);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_ROGUE), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 5);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WARLOCK), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 6);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WARRIOR), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 7);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_PALADIN), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 8);
    ...
    case GOSSIP_ACTION_INFO_DEF + 14:
    {
        ...
        switch (rand() % 4)
        {
        case 0: ItemID = 22142; break;
        case 1: ItemID = 22123; break;
        case 2: ItemID = 22164; break;
        case 3: ItemID = 22156; break;
        }
        uint8 msg = player->CanStoreNewItem(NULL_BAG, NULL_SLOT, dest, ItemID, 1);
        if (msg == EQUIP_ERR_OK)
        {
...
{
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_TAVERN), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BANK), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_INN), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_FLIGHTMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_MAILBOX), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_STABLEMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BATTLEMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 7);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_PROFTRAINER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 8);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_MANALOOM), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 9);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_ALCHEMYLAB), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 10);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_GEMMERCHANT), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 11);
...
void SendDefaultMenu_guard_shattrath(Player *player, Creature *_Creature, uint32 action)
{
    ...
    case GOSSIP_ACTION_INFO_DEF + 1:                    //Tavern
        ...
        break;
    case GOSSIP_ACTION_INFO_DEF + 2:                    //Bank
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BANKALDOR), GOSSIP_SENDER_SEC_BANK, GOSSIP_ACTION_INFO_DEF + 1);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BANKSCYERS), GOSSIP_SENDER_SEC_BANK, GOSSIP_ACTION_INFO_DEF + 2);
        player->SEND_GOSSIP_MENU(10379, _Creature->GetGUID());
        break;
    case GOSSIP_ACTION_INFO_DEF + 3:                    //Inn
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_INNALDOR), GOSSIP_SENDER_SEC_INN, GOSSIP_ACTION_INFO_DEF + 1);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_INNSCYERS), GOSSIP_SENDER_SEC_INN, GOSSIP_ACTION_INFO_DEF + 2);
    ...
    case GOSSIP_ACTION_INFO_DEF + 4:                    //Flight master
        ...
        break;
    case GOSSIP_ACTION_INFO_DEF + 5:                    //Mailbox
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BANKALDOR), GOSSIP_SENDER_SEC_MAILBOX, GOSSIP_ACTION_INFO_DEF + 1);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_INNALDOR), GOSSIP_SENDER_SEC_MAILBOX, GOSSIP_ACTION_INFO_DEF + 2);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BANKSCYERS), GOSSIP_SENDER_SEC_MAILBOX, GOSSIP_ACTION_INFO_DEF + 3);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_INNSCYERS), GOSSIP_SENDER_SEC_MAILBOX, GOSSIP_ACTION_INFO_DEF + 4);
        player->SEND_GOSSIP_MENU(10386, _Creature->GetGUID());
        break;
    case GOSSIP_ACTION_INFO_DEF + 6:                    //Stable master
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_STABLEALDOR), GOSSIP_SENDER_SEC_STABLEMASTER, GOSSIP_ACTION_INFO_DEF + 1);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_STABLESCYERS), GOSSIP_SENDER_SEC_STABLEMASTER, GOSSIP_ACTION_INFO_DEF + 2);
        player->SEND_GOSSIP_MENU(10387, _Creature->GetGUID());
        break;
    case GOSSIP_ACTION_INFO_DEF + 7:                    //Battlemaster
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BATTLEMASTERALLIANCE), GOSSIP_SENDER_SEC_BATTLEINFO, GOSSIP_ACTION_INFO_DEF + 1);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BATTLEMASTERHORDE), GOSSIP_SENDER_SEC_BATTLEINFO, GOSSIP_ACTION_INFO_DEF + 2);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BATTLEMASTERARENA), GOSSIP_SENDER_SEC_BATTLEINFO, GOSSIP_ACTION_INFO_DEF + 3);
    ...
    case GOSSIP_ACTION_INFO_DEF + 8:                    //Profession master
        ...
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_ENCHANTING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 4);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_FIRSTAID), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 5);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_JEWELCRAFTING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 6);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_LEATHERWORKING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 7);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_SKINNING), GOSSIP_SENDER_SEC_PROFTRAIN, GOSSIP_ACTION_INFO_DEF + 8);
    ...
    case GOSSIP_ACTION_INFO_DEF + 11:                   //Gem Merchant
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_GEMALDOR), GOSSIP_SENDER_SEC_GEMMERCHANT, GOSSIP_ACTION_INFO_DEF + 1);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_GEMSCYERS), GOSSIP_SENDER_SEC_GEMMERCHANT, GOSSIP_ACTION_INFO_DEF + 2);
...
struct guard_shattrath_aldorAI : public guardAI
{
    ...
    Timer_UnCheked Exile_Timer;
    Timer_UnCheked Banish_Timer;
    uint64 playerGUID;
    bool CanTeleport;
...
bool GossipHello_guard_silvermoon(Player *player, Creature *_Creature)
{
    ...
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_STABLEMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WEAPONMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 7);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WINDRIDER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 8);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BATTLEMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 9);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_CLASSTRAINER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 10);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_PROFTRAINER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 11);
...
void SendDefaultMenu_guard_silvermoon(Player *player, Creature *_Creature, uint32 action)
{
    ...
    {
    case GOSSIP_ACTION_INFO_DEF + 1:                    //Auction house
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_AH_SILVERMOON_1), GOSSIP_SENDER_SEC_AUCTIONHOUSE, GOSSIP_ACTION_INFO_DEF + 1);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_AH_SILVERMOON_2), GOSSIP_SENDER_SEC_AUCTIONHOUSE, GOSSIP_ACTION_INFO_DEF + 2);
    ...
    case GOSSIP_ACTION_INFO_DEF + 3:                    //Guild master
        ...
        break;
    case GOSSIP_ACTION_INFO_DEF + 4:                    //Inn
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_INN_SILVERMOON_1), GOSSIP_SENDER_SEC_INN, GOSSIP_ACTION_INFO_DEF + 1);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_INN_SILVERMOON_2), GOSSIP_SENDER_SEC_INN, GOSSIP_ACTION_INFO_DEF + 2);
...
{
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_AUCTIONHOUSE), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_STORMWIND_BANK), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_DEEPRUNTRAM), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_INN), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_GRYPHON), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_GUILDMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_MAILBOX), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 7);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_STABLEMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 8);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WEAPONMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 9);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_OFFICERS), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 10);
...
void SendDefaultMenu_guard_stormwind(Player *player, Creature *_Creature, uint32 action)
{
    ...
    case GOSSIP_ACTION_INFO_DEF + 12:                   //Class trainers
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_MAGE), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 1);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_ROGUE), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 2);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WARRIOR), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 3);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_DRUID), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 4);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_PRIEST), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 5);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_PALADIN), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 6);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_HUNTER), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 7);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WARLOCK), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 8);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_SHAMAN), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 9);
    ...
    case GOSSIP_ACTION_INFO_DEF + 14:
    {
        ...
        switch (rand() % 4)
        {
        case 0: ItemID = 22143; break;
        case 1: ItemID = 22117; break;
        case 2: ItemID = 21981; break;
        case 3: ItemID = 21975; break;
        }
        uint8 msg = player->CanStoreNewItem(NULL_BAG, NULL_SLOT, dest, ItemID, 1);
        if (msg == EQUIP_ERR_OK)
        {
...
{
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BANK), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_FERRY), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_GUILDMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_INN), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_STABLEMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_CLASSTRAINER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
...
{
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BANK), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_BATHANDLER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_INN), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_STABLEMASTER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_CLASSTRAINER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);
    player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_PROFTRAINER), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
...
void SendDefaultMenu_guard_tirisfal(Player *player, Creature *_Creature, uint32 action)
{
    ...
    case GOSSIP_ACTION_INFO_DEF + 5:                    //Class trainer
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_MAGE), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 1);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_PRIEST), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 2);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_ROGUE), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 3);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WARLOCK), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 4);
        player->ADD_GOSSIP_ITEM(0, player->GetSession()->GetNpcOptionLocaleString(GOSSIP_TEXT_WARRIOR), GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 5);
        player->SEND_GOSSIP_MENU(4292, _Creature->GetGUID());
        break;
    case GOSSIP_ACTION_INFO_DEF + 6:                    //Profession trainer
...
void SendDefaultMenu_guard_undercity(Player *player, Creature *_Creature, uint32 action)
{
    ...
    case GOSSIP_ACTION_INFO_DEF + 13:
    {
        ...
        switch (rand() % 4)
        {
        case 0: ItemID = 22145; break;
        case 1: ItemID = 22121; break;
        case 2: ItemID = 22166; break;
        case 3: ItemID = 22157; break;
        }
        uint8 msg = player->CanStoreNewItem(NULL_BAG, NULL_SLOT, dest, ItemID, 1);
        if (msg == EQUIP_ERR_OK)
        {
...
void SendClassTrainerMenu_guard_undercity(Player *player, Creature *_Creature, uint32 action)
{
    ...
    case GOSSIP_ACTION_INFO_DEF + 5:                    //Warrior
        ...
        break;
    case GOSSIP_ACTION_INFO_DEF + 6:                    //Paladin
        player->SEND_POI(1298.99, 316.802, 6, 6, 0, "Undercity Paladin Trainers");
        player->SEND_GOSSIP_MENU(5624, _Creature->GetGUID());
        break;
    }
}
