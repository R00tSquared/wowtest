...
//custom
extern void AddSC_Npc_Item_Sender();
extern void AddSC_Npc_Referral();
extern void AddSC_Guild_House();
extern void AddSC_Instance_Teleporter();
extern void AddSC_npc_golem_guardian();

extern void AddSC_DeathSide_Item_Teleporter();
extern void AddSC_mw_npc_chudomuts();
extern void AddSC_mw_npc_dresser();

//extern void AddSC_DeathSide_pvp_master();
extern void AddSC_MW_bg_reg_anywhere();
extern void AddSC_DeathSide_Training_Dummy();
extern void AddSC_DeathSide_Mine_Worker();
extern void AddSC_DeathSide_Mine_Guard();
//extern void AddSC_DeathSide_Npc_Mark_Exchanger();
extern void AddSC_npc_areaguard();

extern void AddSC_DeathSide_Npc_Pet_Master();


extern void AddSC_DeathSide_Item_Transmogrification();
extern void AddSC_deathside_npc_enchanter();
extern void AddSC_DeathSide_New_Year_2017();

extern void AddSC_DeathSide_npc_shop();

extern void AddSC_MW_referral_quest_item();
extern void AddSC_MW_npc_premium();
extern void AddSC_MW_race_change_item();
extern void AddSC_HonorExchanger();
extern void AddSC_MountVendor();
extern void AddSC_Item_Dualspec();
...
extern void AddSC_av_quest_scripts();
...
extern void AddSC_instance_auchenai_crypts();
...
extern void AddSC_trash_instance_blood_furnace();
...
extern void AddSC_trash_hellfire_ramparts();
...
extern void AddSC_trash_naxxramas();
//Netherstorm
...
extern void AddSC_boss_soccothrates_and_daliah();
...
extern void AddSC_trash_botanica();
extern void AddSC_boss_thorngrin_the_tender();
extern void AddSC_boss_commander_sarannis();
...
extern void AddSC_quest_in_dreams();
...
extern void AddSC_midsummer();
extern void AddSC_loveisintheair();

// MW custom
extern void AddSC_BM();
extern void AddSC_AM();
extern void AddSC_DeathSide_Npc_Raid_Master();
extern void AddSC_mw_npc_raid_quest();
extern void AddSC_NPC_Multivendor();
extern void AddSC_raidchest();
extern void AddSC_enchant_legendary();

void AddScripts()
{
    //Custom
    AddSC_enchant_legendary();
    AddSC_raidchest();
    AddSC_NPC_Multivendor();
    AddSC_npc_golem_guardian();
    AddSC_mw_npc_raid_quest();
    AddSC_Npc_Item_Sender();
    AddSC_Npc_Referral();
    AddSC_Guild_House();
    AddSC_Npc_Welcome();
    AddSC_BM(); // BG master
    AddSC_AM(); // Arena master
    AddSC_Item_Dualspec();
    AddSC_Instance_Teleporter();
    AddSC_MountVendor();
    AddSC_HonorExchanger();
    AddSC_DeathSide_Npc_Raid_Master();

    AddSC_DeathSide_Item_Teleporter();
    AddSC_mw_npc_chudomuts();
    AddSC_mw_npc_dresser();

    AddSC_MW_bg_reg_anywhere();
    //AddSC_DeathSide_pvp_master();
    AddSC_DeathSide_Training_Dummy();

    //AddSC_DeathSide_Npc_Mark_Exchanger();
    AddSC_npc_areaguard();
    AddSC_DeathSide_Npc_Pet_Master();
    AddSC_DeathSide_Item_Transmogrification();
    AddSC_deathside_npc_enchanter();
    AddSC_DeathSide_New_Year_2017();
    AddSC_DeathSide_npc_shop();
    AddSC_MW_referral_quest_item();
    AddSC_MW_npc_premium();
    AddSC_MW_race_change_item();
    ...
    AddSC_trash_instance_blood_furnace();
    ...
    AddSC_boss_soccothrates_and_daliah();
