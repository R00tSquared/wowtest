...
class HELLGROUND_EXPORT UnitAI
{
    ...
    public:
        ...
        Unit* SelectLowestHpFriendly(float range, uint32 MinHPDiff = 1, bool targetSelf = false);
        ...
        //Returns a list of all friendly units that has something to dispell within range
        std::list<Creature*> FindAllCreaturesWithDispellMask(float range, uint32 dispelMask);
