...
#ifndef HELLGROUND_CHANNEL_H
#define HELLGROUND_CHANNEL_H
...
enum ChannelFlags
    {
        ...
        /*This one is used only for custom Global channel at the moment*/
        CHANNEL_FLAG_GLOBAL     = 0x08,
...
class Channel
{
    ...
    public:
        ...
        bool IsConstant() const { return m_channelId != 0 || m_flags & CHANNEL_FLAG_GLOBAL; }
        ...
        void Say(uint64 p, const char *what, uint32 lang, bool bad_lexics);
        void Invite(uint64 p, const char *newp, bool checkNotOnChannel = true);
