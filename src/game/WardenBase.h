...
class WardenBase
{
    ...
    public:
        ...
        virtual void RequestAdditionalMemCheck(uint32 checkId);
        void ForceRequest(); // sets warden timer to 0 and, if possible, inits RequestData(). If warden data was already sent -> then next warden request will be sent immediately after receiving previous
