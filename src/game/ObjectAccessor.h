...
class ObjectAccessor
{
    ...
    public:
        ...
        static Player* GetPlayerInWorld(uint64);
        static Player* GetPlayerInWorldOrNot(uint64 guid);
        static Player* GetPlayerOnline(uint64 guid);
        ...
        Player* GetPlayerByNameInWorld(const char *name);
        Player* GetPlayerByNameInWorld(std::string &name);
