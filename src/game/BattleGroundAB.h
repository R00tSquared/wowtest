...
#ifndef HELLGROUND_BATTLEGROUNDAB_H
#define HELLGROUND_BATTLEGROUNDAB_H
...
enum BG_AB_BattleGroundNodes
{
    ...
    BG_AB_ALL_NODES_COUNT       = 9,                        // all nodes (dynamic and static)
    // dont forget to BG_AB_ALL_NODES_COUNT - custom_npc_count
};

const uint8 custom_npc_count = 2;
...
const uint32 BG_AB_GraveyardIds[BG_AB_ALL_NODES_COUNT - custom_npc_count] = { 895, 894, 893, 897, 896, 898, 899 };
...
// x, y, z, o
const float BG_AB_SpiritGuidePos[BG_AB_ALL_NODES_COUNT - custom_npc_count][4] = {
...
class BattleGroundAB : public BattleGround
{
    ...
    private:
        ...
        void _NodeOccupied(uint8 node, PlayerTeam team);
