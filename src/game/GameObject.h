...
class HELLGROUND_IMPORT_EXPORT GameObject : public WorldObject
{
    public:
        ...
        /*used by gob modification GM commands*/
        void SaveUpdateToDB();                            
        /*MUST ONLY be called by SaveUpdateToDB() or .gob add command. Any other usage is FORBIDDEN*/
        void SaveUpdateOrNewToDB_gob_add(uint32 mapid, uint8 spawnMask);
        /*Must ONLY be called by ".gob del" command. Any other usage is FORBIDDEN*/
        void DeleteFromDB_gob_del();
        ...
        int32 GetCooldownTimeLeft() { return (m_cooldownTime - time(NULL)); }
