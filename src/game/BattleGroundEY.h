...
#ifndef HELLGROUND_BATTLEGROUNDEY_H
#define HELLGROUND_BATTLEGROUNDEY_H
...
class BattleGroundEY : public BattleGround
{
    ...
    private:
        ...
        void UpdatePointsCount(PlayerTeam Team);
        void UpdatePointsIcons(PlayerTeam Team, uint32 Point);
        ...
        /* Scorekeeping */
        void AddPoints(PlayerTeam Team, uint32 Points);

        void RemovePoint(PlayerTeam TeamID, uint32 Points = 1) { m_TeamScores[GetTeamIndexByTeamId(TeamID)] -= Points; }
        void SetTeamPoint(PlayerTeam TeamID, uint32 Points = 0) { m_TeamScores[GetTeamIndexByTeamId(TeamID)] = Points; }
        ...
        PlayerTeam m_PointOwnedByTeam[EY_POINTS_MAX];
