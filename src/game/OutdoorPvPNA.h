...
#ifndef HELLGROUND_OUTDOOR_PVP_NA_H
#define HELLGROUND_OUTDOOR_PVP_NA_H
...
protected:
    ...
    void FactionTakeOver(PlayerTeam team);

    void DeSpawnNPCs();
    void DeSpawnGOs();
    void SpawnNPCsForTeam(PlayerTeam team);
    void SpawnGOsForTeam(PlayerTeam team);
...
private:
    ...
    PlayerTeam m_ControllingFaction;
