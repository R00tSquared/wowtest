...
#ifndef HELLGROUND_ITEM_H
#define HELLGROUND_ITEM_H
...
///////////////////////////////////// FUN REALM PERM TEMP ENCHANTMENTS - ReinforcementsIDs
#define REINFORCE_STAT_COUNT 10
#define REINFORCE_LEVEL_COUNT 5
const uint16 ReinforcementIDs[REINFORCE_STAT_COUNT][REINFORCE_LEVEL_COUNT] = 
{
    {1585,1591,1598,1606,1614}, // Attack Power
    {2889,2651,2937,2504,2669}, // Spell Damage
    {2310,2316,2323,2331,2339}, // Healing
    {2892,2911,1044,1052,1060}, // Strength
    {90,358,1094,1102,1110}, // Agility
    {94,359,1120,1128,1136}, // Intellect
    {98,360,1146,1154,1162}, // Spirit
    {2868,411,1076,1088,1214}, // Stamina
    {2366,2371,2379,2386,2394}, // mana per 5 sec
    {113,1946,1956,1954,1968}, // defense rating
};

#define LEVEL_5_REINFORCE_VISUAL 55114
/////////////////////////////////////////////
class HELLGROUND_IMPORT_EXPORT Item : public Object
{
    public:
        ...
        int32 GetSpellCharges(uint8 index/*0..5*/ = 0, bool isNormal = true) const;
        ...
        bool hasQuest(uint32 quest_id) const { return GetProto()->StartQuest == quest_id || (GetProto()->ItemId == REWARD_ORDER && quest_id == 695000); }
