...
enum BG_AV_CREDITMARKERS
{
    BG_AV_GY_CREDITMARKER        =13756,
    BG_AV_TOWER_CREDITMARKER     =13778,
    BG_AV_MINE_CREDITMARKER      =13796
};
...
//horde  (coords not 100% ok)
    {-1366.81f,-219.23f,98.42f,4.63f},
    {-1363.44f,-220.35f,98.39f,4.36f},
    {-1373.61f,-220.94f,98.42f,5.47f},
    {-1375.82f,-223.83f,98.42f,5.88f},
...
enum BG_AV_CreatureIds
{
    ...
    AV_NPC_N_MINE_H_3      = 32, // Irondeep surveyor
    AV_NPC_N_MINE_H_4      = 33, // Umi Thorson
    AV_NPC_S_MINE_N_1      = 34,
    AV_NPC_S_MINE_N_2      = 35,
    AV_NPC_S_MINE_N_3      = 36,
    AV_NPC_S_MINE_N_4      = 37,
    AV_NPC_S_MINE_N_S      = 38, // Whitewhisker Vermin
    AV_NPC_S_MINE_A_1      = 39,
    AV_NPC_S_MINE_A_2      = 40, // Coldmine Explorer
    AV_NPC_S_MINE_A_3      = 41, // Coldmine Invader
    AV_NPC_S_MINE_A_4      = 42,
    AV_NPC_S_MINE_H_1      = 43,
    AV_NPC_S_MINE_H_2      = 44, // Coldmine Surveyor
    AV_NPC_S_MINE_H_3      = 45, // Coldmine Guard
    AV_NPC_S_MINE_H_4      = 46,
    AV_NPC_HERALD          = 47,
    // Irondeep Seasoned
    AV_NPC_N_MINE_A_5      = 48,
    AV_NPC_N_MINE_A_6      = 49,
    AV_NPC_N_MINE_H_5      = 50,
    AV_NPC_N_MINE_H_6      = 51,
    // Irondeep Veteran
    AV_NPC_N_MINE_A_7      = 52,
    AV_NPC_N_MINE_A_8      = 53,
    AV_NPC_N_MINE_H_7      = 54,
    AV_NPC_N_MINE_H_8      = 55,
    // Irondeep Champion
    AV_NPC_N_MINE_A_9      = 56,
    AV_NPC_N_MINE_A_10     = 57,
    AV_NPC_N_MINE_H_9      = 58,
    AV_NPC_N_MINE_H_10     = 59,
    // Coldmine Seasoned
    AV_NPC_S_MINE_A_5      = 60,
    AV_NPC_S_MINE_A_6      = 61,
    AV_NPC_S_MINE_H_5      = 62,
    AV_NPC_S_MINE_H_6      = 63,
    // Coldmine Veteran
    AV_NPC_S_MINE_A_7      = 64,
    AV_NPC_S_MINE_A_8      = 65,
    AV_NPC_S_MINE_H_7      = 66,
    AV_NPC_S_MINE_H_8      = 67,
    // Coldmine Champion
    AV_NPC_S_MINE_A_9      = 68,
    AV_NPC_S_MINE_A_10     = 69,
    AV_NPC_S_MINE_H_9      = 70,
    AV_NPC_S_MINE_H_10     = 71,
...
const uint32 BG_AV_CreatureInfo[AV_NPC_INFO_MAX] = {
    ...
    13358, //Stormpike Bowman //i think its 60,61 and 69,70.. but this is until now not possible TODO look if this is ok
...
const float BG_AV_StaticCreaturePos[AV_STATICCPLACE_MAX][5] = { //static creatures
    ...
    {-558.69f,-167.75f,57.95f,6.207,16 },//11947 - Captain Galvangar
    ...
    {-1206.664795f, -288.229523f, 71.788834f, 4.01139f,20 },//12051 - Frostwolf Legionnaire 
    ...
    { -1169.294922f, -353.431335f, 51.962147f,0.0879f,38 },//13798 - Jotek
    ...
    {-1205.260498f, -289.596802f, 71.838303f, 4.0131f, 44 },//14282 - Frostwolf Bloodhound
    {-1208.149414f, -286.784119f, 71.853073f, 4.0145f, 44 },//14282 - Frostwolf Bloodhound 
    ...
    {-1370.204f,-219.52f,98.4267f,5.02381f,47}, //drek thar

};

const uint32 BG_AV_StaticCreatureInfo[48] = {
    2225, //Zora Guthrek
    3343, //Grelkor
    3625, //Rarck
...
{ //TODO add all other buffs here
    // quest buff given when turning in armor scraps, each quest turn-in gives buff
    AV_BUFF_ARMOR = 21163,
    /* every 10 minutes while captain is still alive. 
    Comments in code say that it should also be given after killing a captain, not sure about that*/
    AV_BUFF_A_CAPTAIN = 23693,
    AV_BUFF_H_CAPTAIN = 22751,

    /* general warcry. Period is unknown (i suppose goes along with captain's buff). 
    Three levels each represent 500/1000/1500 armor scraps*/
    AV_BUFF_GENERAL_10_DMG = 28418,
    AV_BUFF_GENERAL_20_DMG = 28419,
    AV_BUFF_GENERAL_30_DMG = 28420
};
enum BG_AV_States
{
    POINT_NEUTRAL              =  0,
...
{
    PlayerTeam       TotalOwner;
    PlayerTeam       Owner;
    PlayerTeam       PrevOwner;
    BG_AV_States State;
...
class BattleGroundAV : public BattleGround
{
    ...
    public:
        ...
        /*general stuff*/
        virtual uint32 GetTeamScore(PlayerTeam team) const            { return m_Team_Scores[GetTeamIndexByTeamId(team)]; }
        void UpdateScore(PlayerTeam team, int16 points);
        ...
        bool PlayerCanDoMineQuest(int32 GOId, PlayerTeam team);
    ...
    private:
        ...
        void AssaultNode(BG_AV_Nodes node, PlayerTeam team);
        void DestroyNode(BG_AV_Nodes node);
        void InitNode(BG_AV_Nodes node, PlayerTeam team, bool tower);
        void DefendNode(BG_AV_Nodes node, PlayerTeam team);
        ...
        /*mine*/
        void ChangeMineOwner(uint8 mine, PlayerTeam team, bool initial=false, bool onlyImprove = false);
