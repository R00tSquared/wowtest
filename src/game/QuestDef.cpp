...
Quest::Quest(Field * questRecord, bool available)
{
    QuestId = questRecord[0].GetUInt32();
    QuestMethod = questRecord[1].GetUInt32();
    ZoneOrSort = questRecord[2].GetInt32();
    SkillOrClass = questRecord[3].GetInt32();
    MinLevel = available ? questRecord[4].GetUInt32() : (sWorld.getConfig(CONFIG_MAX_PLAYER_LEVEL) + sWorld.getConfig(CONFIG_QUEST_HIGH_LEVEL_HIDE_DIFF) + 1);
