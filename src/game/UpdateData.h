...
#ifndef HELLGROUND_UPDATEDATA_H
#define HELLGROUND_UPDATEDATA_H
...
enum OBJECT_UPDATE_FLAGS
{
    ...
    UPDATEFLAG_HAS_ATTACKING_TARGET     = 0x04,
...
class UpdateData
{
    public:
        ...
        bool BuildPacket(WorldPacket *packet, bool hasTransport = false) const;
