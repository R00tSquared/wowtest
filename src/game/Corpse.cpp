...
{
    SetInstanceId(owner->GetAnyInstanceId());
...
void Corpse::SaveToDB()
{
    ...
    stmt.addInt32(GetInstanciableInstanceId());
...
bool Corpse::LoadFromDB(uint32 guid, Field *fields)
{
    ...
    if (!instanceid) // not instanciated
        instanceid = sObjectMgr.GetSingleInstance(mapid, positionX, positionY);
