...
class PoolGroup
{
    ...
    public:
        ...
        /* for load check */
        uint32 GetLimit() const { return maxLimit; }
        ...
        void SpawnObject(SpawnedPoolData& spawns, uint32 triggerFromPoolOrObject, uint32 triggerFromObject);

        void Spawn1Object(PoolObject* obj, uint32 triggerFromObject);
...
class PoolManager
{
    ...
    public:
        ...
        void SpawnPool(uint16 pool_id, uint32 triggerFromObject);
        void DespawnPool(uint16 pool_id);

        template<typename T>
        void UpdatePool(uint16 pool_id, uint32 triggerFrom);
    protected:
        template<typename T>
        void SpawnPoolGroup(uint16 pool_id, uint32 triggerFromPoolOrObject, uint32 triggerFromObject);
