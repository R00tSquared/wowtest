...
enum AuraSpecialFlag
{
    AURA_SPECIAL_NONE = 0,
    AURA_SPECIAL_SEALTWIST = 1,
};
...
enum AuraType
{
    ...
    SPELL_AURA_253 = 253,
    SPELL_AURA_254 = 254,
    SPELL_AURA_PERMANENT_TRANSFORM = 255,
    SPELL_AURA_SEND_SPELL_VISUAL_PERIODIC = 256,
    SPELL_AURA_257 = 257,
    SPELL_AURA_258 = 258,
    SPELL_AURA_259 = 259,
    SPELL_AURA_SPECTATOR_VISIBLE = 260,
    SPELL_AURA_261 = 261,
    TOTAL_AURAS=262
};
