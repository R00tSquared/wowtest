...
bool LexicsCutter::CheckLexics(std::string Phrase)
{
    ...
    /* if (Phrase.find("|Hitem:19:0:0:0:0:0:0:0|") != std::string::npos) // colorme
        Phrase.clear(); */

        //if (Phrase.find("|cffffff00|T:9999:300:3000|t|T:300|") != std::string::npos) // roll in chat
        //    Phrase.clear();

        //if (Phrase.find("TInterface") != std::string::npos) // icons in chat
        //    Phrase.clear();
