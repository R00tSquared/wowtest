...
{
    SPEC_MASK_NONE = 0,
    SPEC_MASK_PHYSICAL_DD = 1,
    SPEC_MASK_SPELL_DD = 2,
    SPEC_MASK_HEALER = 4,
    SPEC_MASK_TANK = 8,
};
...
enum CaptchaActions
{
	CAPTCHA_BUY_VENDOR_RESTOCKED = 1,
	CAPTCHA_LOOT_PROF = 2,
	CAPTCHA_LOOT_CORPSE = 3,
	CAPTCHA_SEND_MAIL = 4,
};
...
const uint32 ItemQualityColorsSpecial[MAX_ITEM_QUALITY] =
{
    0xff9d9d9d,        //GREY
    0xffffffff,        //WHITE
    0xff29f20f,        //GREEN
...
#define SPELL_ATTR_EX_NOT_BREAK_CASTER_STEALTH    0x00000020            // 5 Not break stealth
...
#define SPELL_ATTR_EX_CHANNELLED_HASTE_UNAFFECTED 0x00002000            // 13 channelled spells are unaffected by haste bonus. tooltip like 'lasts for %u'
...
#define SPELL_ATTR_EX2_NOT_CONSIDERED_HIT         0x10000000            // 28 Such spells don't break AURA_INTERRUPT_HITBYSPELL auras
...
#define SPELL_ATTR_EX3_DYNOBJ_TRIGGERED_LOS_IGNORE 0x02000000            // Blizzard, volley, rain of fire, hurricane. When target is 76
...
#define SPELL_ATTR_EX3_NO_DONE_BONUS              0x20000000            // 29 Things like berserk doesn't apply bonus to overall damage of the spell
...
#define SPELL_ATTR_EX6_ONLY_IN_RAID               0x02000000            // New custom attribute
#define SPELL_ATTR_EX6_BG_DISALLOW_19LVL          0x04000000            // New custom attribute - Disallow to use some items on 19 lvl battleground
#define SPELL_ATTR_EX6_BG_ONLY_CUSTOM             0x08000000            // New custom attribute - On battleground/arenas can only be used from custom items (>100000 id)
#define SPELL_ATTR_EX6_NOT_HUNTER_PVP             0x10000000            // New custom attribute - cannot be used/auras_are_removed in bg, arena, duels, pvp by HUNTERS
#define SPELL_ATTR_EX6_HAS_ANALOG                 0x20000000            // New custom attribute - has analog - sends another id in all logs when casting this spell
#define SPELL_ATTR_EX6_REAL_PPM_SPEED             0x40000000            // New custom attribute - for PPM procs takes REAL weapon speed, after affected by haste - so procs "cooldown" work as intended
#define SPELL_ATTR_EX6_NOT_PVP                    0x80000000            // New custom attribute - cannot be used/auras_are_removed in bg, arena, duels, pvp
...
enum GBK_Encounters
{
    ...
    GBK_ALAR                    = 10,
    GBK_VOID_REAVER             = 11, 
    GBK_HIGH_ASTROMANCER_SOLARIAN = 12,
    ...
    GBK_TERON_GOREFIEND         = 22,
    GBK_GURTOG_BLOODBOIL        = 23,
    GBK_REQUILARY_OF_SOULS      = 24,
    ...
    GBK_MURU                    = 32,
    GBK_KILJAEDEN               = 33,
    GBK_KARA_ATTUNEMENT         = 34,
    GBK_KARA_MOROES             = 35,
    GBK_KARA_MAIDEN             = 36,
    GBK_KARA_CURATOR            = 37,
    GBK_KARA_ARAN               = 38,
    GBK_KARA_TERESTIAN          = 39,
    GBK_KARA_NETHERSPITE        = 40,
    GBK_KARA_MALCHEZAR          = 41,
    GBK_KARA_NIGHTBANE          = 42,
    GBK_ZA_NALORAK              = 43,
    GBK_ZA_AKILZON              = 44,
    GBK_ZA_JANALAI              = 45,
    GBK_ZA_HALAZZI              = 46,
    ...
    GBK_HR_GARGOLMAR            = 49, // hellfire ramparts
    GBK_HR_OMOR                 = 50,
    GBK_HR_NAZAN                = 51,
    GBK_BF_MAKER                = 52, // blood furnance
    GBK_BF_BROGG                = 53,
    GBK_BF_KELID                = 54,
    GBK_SHH_NETHERKURSE         = 55, // shattered halls
    GBK_SHH_WARBRINGER          = 56,
    GBK_SHH_PORUNG              = 57,
    GBK_SHH_KARGATH             = 58,
    GBK_MT_YOREVENT             = 59, // mana tombs
    GBK_MT_PANDEMONIUS          = 60,
    GBK_MT_NEXUSPRINCE          = 61,
    GBK_MT_SHAHEEN              = 62, // sethekk halls
    GBK_SH_IKISS                = 63,
    GBK_SH_ANZU                 = 64,
    GBK_SH_DARKWEAVER           = 65,
    GBK_SH_LAKKA                = 66, // not used
    GBK_SL_HELLMAW              = 67, // shadow labyrinth
    GBK_SL_BLACKHEARTH          = 68,
    GBK_SL_VORPIL               = 69,
    GBK_SL_MURMUR               = 70,
    GBK_SV_HYDROMANCER_THEPSIA  = 71, // steamvault
    GBK_SV_MEKGINEER_STEAM      = 72,
    GBK_SV_WARLORD_KALITHRESH   = 73,
    GBK_AR_ZEREKETH             = 74, // arcatraz
    GBK_AR_DALLIAH              = 75,
    GBK_AR_SOCCOTHRATES         = 76,
    GBK_AR_SKYRISS              = 77,
    GBK_MECH_NETHERMANCER       = 78, // mechanar
    GBK_MECH_IRONHAND           = 79,
    GBK_MECH_GYROKILL           = 80,
    GBK_MECH_MECHANOLORD        = 81,
    GBK_MECH_PATHAELON          = 82,
    GBK_BOT_SARANNIS            = 83, // botanica
    GBK_BOT_FREY                = 84,
    GBK_BOT_THORN               = 85,
    GBK_BOT_LAJ                 = 86,
    GBK_BOT_WARP                = 87,
    GBK_AC_SHIRAKK              = 88, // auchenai crypts
    GBK_AC_EXARACH              = 89,
    GBK_UB_HUNGARFEN            = 90, // underbog
    GBK_UB_GHAHZAN              = 91,
    GBK_UB_SWAMPLORD            = 92,
    GBK_UB_BLACKSTALKER         = 93,
    GBK_SP_AHUNE                = 94, // slave pens
    GBK_SP_MENNU                = 95,
    GBK_SP_ROKMAR               = 96,
    GBK_SP_QUAGMIRRAN           = 97,
    GBK_DP_TEMPORUS             = 98,
    GBK_DP_AEONUS               = 99,
    GBK_DP_DEJA                 = 100,
    GBK_OHF_SKARLOC             = 101,
    GBK_OHF_EPOCH               = 102,
    GBK_OHF_LEUTENANT           = 103,
    ...
    GBK_GROBBULUS = 108,
    GBK_GLUTH = 109,
    GBK_HEIGAN_THE_UNCLEAN = 110,
    GBK_MAEXXNA = 111,
    GBK_GRAND_WIDOW_FAERLINA = 112,
    GBK_NOTH_THE_PLAGUEBRINGER = 113,
    GBK_ANUB_REKHAN = 114,
    GBK_LOATHEB = 115,
    GBK_PATCHWERK = 116,
    GBK_GOTHIK_THE_HARVESTER = 117,
    GBK_INSTRUCTOR_RAZUVIOUS = 118,
    GBK_FOUR_HORSEMEN = 119,
    GBK_SAPPHIRON = 120,
    GBK_KEL_THUZAD = 121,

    // don't forget to update LastBoss()
    GBK_ANTISPAMINLOGSINATOR    = 130
};
...
#define SINGLEINSTANCE_RESERVED_INSTANCES_LAST 100
#define OTHER_TEAM(a) (a == TEAM_ALLIANCE ? TEAM_HORDE : TEAM_ALLIANCE)
#define OTHER_PLAYER_TEAM(a) (a == ALLIANCE ? HORDE : ALLIANCE)
#define TEAM_FACTION(a) (a == TEAM_ALLIANCE ? ALLIANCE : HORDE)
