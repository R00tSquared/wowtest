...
#ifndef HELLGROUND_ITEMPROTOTYPE_H
#define HELLGROUND_ITEMPROTOTYPE_H
...
enum ItemBondingType
{
    ...
    BIND_WHEN_EQUIPED                           = 2,
    BIND_WHEN_USE                               = 3,
    BIND_QUEST_ITEM                             = 4,        // not tradable
    BIND_QUEST_ITEM1                            = 5         // tradable
};
...
enum ITEM_FLAGS
{
    ...
    ITEM_FLAGS_CUSTOM                         = 0x00001000, // custom usage (antique mounts disenchant)
