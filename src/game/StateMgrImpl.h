...
#ifndef HELLGROUND_STATEMGRIMPL_H
#define HELLGROUND_STATEMGRIMPL_H
...
enum UnitActionPriority
{
    ...
    UNIT_ACTION_PRIORITY_DISTRACT    =  3,
    UNIT_ACTION_PRIORITY_CHASE       =  4,
    UNIT_ACTION_PRIORITY_ASSISTANCE  =  5,
    UNIT_ACTION_PRIORITY_CONTROLLED  =  6,
    UNIT_ACTION_PRIORITY_FEARED      =  7,
    UNIT_ACTION_PRIORITY_CONFUSED    =  8,
    UNIT_ACTION_PRIORITY_ROOT        =  9,
