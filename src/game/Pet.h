...
#ifndef HELLGROUND_PET_H
#define HELLGROUND_PET_H
...
#define PET_OOC_SPEED_SPELL 55323
#define PET_OOC_SPEED_SPELL_RUN_EFF 0
#define PET_OOC_SPEED_SPELL_SWIM_EFF 1

class HELLGROUND_IMPORT_EXPORT Pet : public Creature
{
    public:
        ...
        /*Adds speed aura if does not have one and if both pet and owner are out of combat*/
