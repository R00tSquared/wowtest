...
protected:
    ...
    void LinkGraveYard(PlayerTeam team);
    void SummonShrine(PlayerTeam team);
    void SummonSupportUnits(PlayerTeam team);
    void SummonFlightMaster(PlayerTeam team);
    ...
    PlayerTeam EP_TOWER_EVENT_TEAM[EP_TOWER_NUM];
private:
