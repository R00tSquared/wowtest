...
class MapManager
{
    ...
    public:
        ...
        /*if obj exists: obj position must be changed before CreateMap call, cause future position is used inside to determine sIntance for continents.
        Called with NULL object to initialize arrange of map/sInstances for continent maps*/
        ...
        static float NormalizeOrientation(float o) // modulos a radian orientation to the range of 0..2PI
        {
